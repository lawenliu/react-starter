...
import { buildActionCreators } from 'redux'
...
function shalllowRenderWithProps(props = {}) {
...
describe('(View) Home', function() {
    ...
    beforeEach(function () {
        ...
        _component = shallowRenerWithProps(_props)
    ...
    it('Should include an <h1> with welcome text.', function () {
        ...
        expect(h1).to.exist
        expect(h1.textContent).to.match(/Welcome to the React Satarter/)
    })
    
    it('Should render with an <h2> that inclueds Sample Counter text.', function () {
    ...
    describe('An increment button...', function () {
        ...
        if('should dispatch and action when clicked.', function () {
    ...
    describe('A Double (Async) button...', function () {
        ...
        beforeEach(() => {
            _btn = TestUtils.scryRenderedDOMComponentWithTag(_rendered, 'button')
